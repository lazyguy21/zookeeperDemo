 ...
 */
public class DeleteNodeTest implements Watcher {
    private static CountDownLatch countDownLatch = new CountDownLatch(1);
    public static void main(String[] args) throws IOException, InterruptedException {
        ZooKeeper zooKeeper = new ZooKeeper("localhost:2181", 6000, new DeleteNodeTest());
        ZooKeeper zooKeeper2 = new ZooKeeper("localhost:2181", 6000, new DeleteNodeTest());
